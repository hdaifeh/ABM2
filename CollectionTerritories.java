...
public class CollectionTerritories {
   ...
   // Individual [] myIndividual
    ...
    public CollectionTerritories(Territory mt, int id) {
       ...
       // public CollectionTerritories(Individual mt, int idd) {
       // myIndividual = mt;
      //  ident = idd;
  //  }

    /*
        public CollectionTerritories(int nbYears, int nbIndividuals, double[] paramsTerritory, double[][] paramsSubTerritories, boolean printTraj) {

        refYear = 0; //
        printTrajectory = printTraj;
        myIndividual = new CollectionTerritories[nbIndividuals];
        int sizeData = nbYears + 1;
        for (int i = 0; i < nbIndividuals; i++) {
            myIndividual[i] = new CollectionTerritories(this, i);
